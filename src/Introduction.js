    ...
    <>
        ...
        <body id="intro_bootstrap">
            ...
            <div class="my_container">
                    <h1 class="big_font" id="heading"></h1>
                    <div class="gradient-cards">
                        <div class="card my-card">
                          <div class="container-card bg-green-box zoom2">
                            ...
                            <p class="card-title">Always a learner</p>
                            <p class="card-description">
                              I always believe that in the IT field one cannot stop learning. Learning is the only constant that can make you grow.
                            </p>
                          </div>
                        </div>

                        <div class="card">
                          <div class="container-card bg-white-box zoom2">
                            <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="card-title">Versatility</p>
                            <p class="card-description">Having worked with several programming languages and tech stacks I can always bring diversity to the plate.</p>
                          </div>
                        </div>

                        <div class="card">
                          <div class="container-card bg-yellow-box zoom2">
                            <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="card-title">Good Return of Investment</p>
                            <p class="card-description">Speaking of my past experiences, I provide good return of investments in terms of skills and work.</p>
                          </div>
                        </div>

                        <div class="card">
                          <div class="container-card bg-blue-box zoom2">
                                      <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <p class="card-title">Good Team Player</p>
                                      <p class="card-description">I strive to support a cohesive and supportive team environment and understand the importance of work.</p>
                              </div>
                          </div>
              </div>
